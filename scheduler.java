...
My solution would be successful with other quest boards if they are the quest boards
are in the same format: quests, start data, duration, and reward. My solution is
somewhat efficient as I realized it would be nicer to read in a board
automatically instead of inputting it manually.
*/
class Scheduler {
